...
Spot_Win(NotHTML = 0) {
	...
	If SBText !=
		SBText := _T1 "( StatusBarText ) </span>" _BB1 " id='copy_button'> copy " _BB2 _T2 _PRE1 "<span>" SBText "</span></span>" _PRE2
	WinGetText, WinText, ahk_id %WinID%
	If WinText !=
		WinText := _T1 " ( Window Text ) </span> <a></a>" _T2 _PRE1 "<span name='MS:'>" TransformHTML(WinText) "</span>" _PRE2
	CoordMode, Mouse
