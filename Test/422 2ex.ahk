...
HTML_Control:
	...
	%HTML_ControlExist%
	%CtrlInfo%%CtrlText%%UseUIAStr%%AccText%<a></a>%_T0%   
	)
...
Write_Control() {
	...
	; oDoc.getElementById(oOther.anchor[ThisMode "_text"]).Id := "anchor"
	
	 
	If oAnchor := AnchorColor()
		AnchorScroll(oAnchor)
	...
	; ToolTip % oDoc.getElementById("anchor").outerHTML "`n" 
...
<body id='body'>
<div id='divwork1' class='divwork' onscroll='scrolldiv(this)'></div>
<div id='divwork2' class='divwork' onscroll='scrolldiv(this)'></div>
</body>
